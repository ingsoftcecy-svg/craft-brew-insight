  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-10">
      <div className="flex flex-col gap-4 bg-white/50 p-6 rounded-2xl border border-slate-100 shadow-sm backdrop-blur-sm">
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight text-slate-800">Chequeo a las {tipoChequeo}</h1>
          <p className="text-sm text-slate-500 mt-1 font-medium">Vista dinámica filtrada de Extractos</p>
        </div>
