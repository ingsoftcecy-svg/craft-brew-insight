        ...
        <TableBody>
          {rows.map((r) => (
            ...
            >
              ...
              <CustomTableCell
                className={`text-sm tabular-nums text-center ${!r.h24 ? "text-slate-300" : r.estado24h === "Completado" ? "text-emerald-600 font-bold bg-emerald-50/50" : "text-slate-500 font-medium"}`}
              >
              ...
              <CustomTableCell
                className={`text-sm tabular-nums text-center ${!r.h48 ? "text-slate-300" : r.estado48h === "Completado" ? "text-emerald-600 font-bold bg-emerald-50/50" : "text-slate-500 font-medium"}`}
              >
                <div className="flex items-center justify-center gap-1.5">
              ...
              <CustomTableCell
                className={`text-sm tabular-nums text-center ${!r.h72 ? "text-slate-300" : r.estado72h === "Completado" ? "text-emerald-600 font-bold bg-emerald-50/50" : "text-slate-500 font-medium"}`}
              >
                <div className="flex items-center justify-center gap-1.5">
              ...
              <CustomTableCell
                className={`text-sm tabular-nums text-center ${!r.h96 ? "text-slate-300" : r.estado96h === "Completado" ? "text-emerald-600 font-bold bg-emerald-50/50" : "text-slate-500 font-medium"}`}
              >
                <div className="flex items-center justify-center gap-1.5">
              ...
              <CustomTableCell
                className={`text-sm tabular-nums text-center ${!r.h120 ? "text-slate-300" : r.estado120h === "Completado" ? "text-emerald-600 font-bold bg-emerald-50/50" : "text-slate-500 font-medium"}`}
              >
                <div className="flex items-center justify-center gap-1.5">
              ...
              <CustomTableCell
                className={`border-r-0 text-sm tabular-nums text-center ${!r.h144 ? "text-slate-300" : r.estado144h === "Completado" ? "text-emerald-600 font-bold bg-emerald-50/50" : "text-slate-500 font-medium"}`}
              >
                <div className="flex items-center justify-center gap-1.5">
