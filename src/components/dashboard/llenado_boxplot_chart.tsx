      ...
      <CardContent>
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-4 mb-6">
          ...
          <div className="dashboard-stat-box">
            ...
            <p
              className={`text-xl font-black ${statsGlobales.cp >= 1.33 ? "dashboard-stat-ok" : statsGlobales.cp >= 1 ? "dashboard-stat-warn" : "dashboard-stat-bad"}`}
            >
          ...
          <div className="dashboard-stat-box">
            ...
            <p
              className={`text-xl font-black ${statsGlobales.cpk >= 1.33 ? "dashboard-stat-ok" : statsGlobales.cpk >= 1 ? "dashboard-stat-warn" : "dashboard-stat-bad"}`}
            >
